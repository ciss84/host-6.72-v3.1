...
#if !defined(sun) && !defined(__SCE__)
#include <rtld_db.h>
#endif
...
#if defined(__SCE__)
typedef int dtrace_consume_probe_f(dtrace_hdl_t *, const dtrace_probedata_t *, void *);
#else
...
#if defined(__SCE__)
//#define _SC_CPUID_MAX		(8) // FIXME
//#define _SC_NPROCESSORS_MAX	(8)
