...
#if defined(__ORBIS__)
#define SCE_DTRACE_PROBE_FLAG_ENTER		0x00000001
#define SCE_DTRACE_PROBE_FLAG_RETURN	0x00000002
#define SCE_DTRACE_PROBE_FLAG_SYSCALL	0x00000010
#define SCE_DTRACE_PROBE_FLAG_FBT		0x00000020
#define SCE_DTRACE_PROBE_FLAG_PID		0x00000040
	uint32_t	cpu_probe_flag;
#endif
} solaris_cpu_t; 
