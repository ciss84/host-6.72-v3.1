...
/* yvals.h values header for conforming compilers on various systems */
 ...
 #if defined(_IS_WRS) && (_IS_WRS != 0)	/* compiler test */
 #ifndef _YVALS_WRS
  #define _YVALS_WRS
 ...
 #endif /* _YVALS_WRS */
 #endif /* defined(_IS_WRS) && (_IS_WRS != 0) */
...
#define _M_X64 /*FIXME*/
 ...
 #define _GCC43	(__clang__ || 4 < __GNUC__ \
	|| 4 == __GNUC__ && 3 <= __GNUC_MINOR__)	/* 4.3 or newer */
 #define _GCC44	(__clang__ || 4 < __GNUC__ \
	|| 4 == __GNUC__ && 4 <= __GNUC_MINOR__)	/* 4.4 or newer */
 #define _GCC45	(__clang__ || 4 < __GNUC__ \
	|| 4 == __GNUC__ && 5 <= __GNUC_MINOR__)	/* 4.5 or newer */
 #define _GCC46	(__clang__ || 4 < __GNUC__ \
	|| 4 == __GNUC__ && 6 <= __GNUC_MINOR__)	/* 4.6 or newer */
 #define _GCC47 (__clang__ || 4 < __GNUC__ \
 ...
 */
 ...
 #define _HAS_CONSTEXPR 1
  ...
  /* B#296 has been fixed by Dinkumware V6.0x here. */
  #define _D0		3	/* 0: big endian, 3: little endian floating-point */
  #define _DLONG	1	/* 0: 64, 1: 80, 2: 128 long double bits */
  #define _LBIAS	0x3ffe	/* 80/128 long double bits */
  #define _LOFF		15	/* 80/128 long double bits */
  ...
  #define _MACH_I32	int           /* B#395 */
  #define _MACH_PDT	long
  #define _MACH_SZT	unsigned long /* B#257 */

  #define _LLONG	1	/* 64-bit longs */ /* B#302c16 */
  #define _RSIZE_MAX	((unsigned long)(-1) >> 1)
...
/* B#395 has been fixed by Dinkumware V6.0x here. */
...
/* B#257 has been fixed by Dinkumware V6.0x here. */
...
typedef unsigned int _Sizet;
 ...
 #define _C99 1 /* B#402 */
 ...
 #if _HAS_C9X && (defined(__EDG__) && (__EDG__ != 0)) && !defined(__APPLE__) && !defined(__cplusplus)
  #define _HAS_C9X_IMAGINARY_TYPE	1
  ...
  #define _HAS_DEBUG_COMPATIBILITY	1
		...
		/* EXCEPTION CONTROL */
#define __SCE_LIBC_EXCEPTIONS__ /* B#457 */
 #ifndef _HAS_EXCEPTIONS
  #ifndef _NO_EX	/* don't simplify */

   #ifdef __clang__ /* B#457 */
...
/* #define _STD_USING	define C names in one of three namespaces */
  ...
  #undef _STD_USING	/* define only for C++ */
	...
	&& ((defined(__SUNPRO_CC) && (__SUNPRO_CC != 0)) \
		|| (defined(__EDG__) && (__EDG__ != 0)) && !defined(__APPLE__) && !defined(_WIN32_C_LIB))
...
#define _TLS_QUAL	/* TLS qualifier, such as __declspec(thread), if any */
 ...
 #elif (!defined(_IS_EMBEDDED) || (_IS_EMBEDDED == 0)) && ((defined(_MSC_VER) && (1310 <= _MSC_VER)) || (defined(__EDG__) && (__EDG__ != 0)) || 3 <= __GNUC__)
...
#define _HAS_TR1_DECLARATIONS	_HAS_TR1
 ...
 #elif _HAS_TR1 && ((defined(_MSC_VER) && (1400 <= _MSC_VER)) || (defined(__EDG__) && (__EDG__ != 0)) || __GNUC__)
 ...
 #elif _HAS_CPP0X && defined(__cplusplus) && 201402L <= __cplusplus
  #define _HAS_CPP1X 1
 ...
 #elif (defined(_GCC44) && _GCC44) || 403 <= __EDG_VERSION__
 ...
 #if !defined(__INTELLISENSE__)
  #define _HAS_NOEXCEPT _HAS_CPP0X
 #endif /* !defined(__INTELLISENSE__) */

 #if !defined(_HAS_NOEXCEPT)
  #define _HAS_NOEXCEPT	0	/* disallow noexcept */
  #define _NOEXCEPT
  #define _NOEXCEPT_OP(x)
  #define _NOEXCEPT_14
  #define _NOEXCEPT_11
  #define _NOEXCEPT_OP_11(x)

 #elif _HAS_NOEXCEPT == 0 || !defined(__cplusplus)
  #define _NOEXCEPT
  #define _NOEXCEPT_OP(x)
  #define _NOEXCEPT_14
  #define _NOEXCEPT_11
 ...
 #else /* !defined(_HAS_NOEXCEPT) */
  #define _NOEXCEPT			noexcept
  #define _NOEXCEPT_OP(x)	noexcept(x)

  #if _HAS_CPP1X
   #define _NOEXCEPT_14	noexcept
   #define _NOEXCEPT_11
   #define _NOEXCEPT_OP_11(x)
  #else /* _HAS_CPP1X */
   #define _NOEXCEPT_14
   #define _NOEXCEPT_11	noexcept
   #define _NOEXCEPT_OP_11(x)	noexcept(x)
  #endif /* _HAS_CPP1X */
  ...
  #if _HAS_CPP1X
   #define _CONST_DATA_14	constexpr
   #define _CONST_FUN_14	constexpr
  #else /* _HAS_CPP1X */
   #define _CONST_DATA_14	const
   #define _CONST_FUN_14
  #endif /* _HAS_CPP1X */
 ...
 #if _HAS_CPP1X
  #define _CONST_QUAL_14	const
 #else /* _HAS_CPP1X */
  #define _CONST_QUAL_14
 #endif /* _HAS_CPP1X */

 #if defined(_HAS_DECLTYPE)

 #elif _HAS_CPP0X && ((defined(_MSC_VER) && (1600 <= _MSC_VER)) || (defined(_GCC44) && _GCC44) || 403 <= __EDG_VERSION__)
 ...
 #elif _HAS_CPP0X && ((defined(_GCC44) && _GCC44) || defined(__clang__))
  /* ORBIS: B#1131 */
 ...
 #elif _HAS_CPP0X && ((defined(_MSC_VER) && (1600 <= _MSC_VER)) || (defined(__EDG_VERSION__) && (400 <= __EDG_VERSION__)) || _GCC0X)
  ...
  #define _HAS_RVALUE_REFERENCES	0	/* disable rvalue references */
	...
	&& ((defined(_MSC_VER) && (1600 <= _MSC_VER)) || (defined(__EDG_VERSION__) && (400 <= __EDG_VERSION__)) || _GCC45)
 ...
 #elif _HAS_CPP0X && ((defined(_GCC44) && _GCC44) || 403 <= __EDG_VERSION__)
 ...
 #elif _HAS_CPP0X && ((defined(_MSC_VER) && (1600 <= _MSC_VER)) || _GCC0X || 403 <= __EDG_VERSION__)
 ...
 #elif _HAS_CPP0X && ((defined(__EDG_VERSION__) && (402 <= __EDG_VERSION__)) || _GCC47)
  ...
  #ifdef __ORBIS__ /* ORBIS B#7689 */
  #define _USE_EXISTING_SYSTEM_NAMES	0	/* _Open => open, etc. */
  #else /* __ORBIS__ */
  #define _USE_EXISTING_SYSTEM_NAMES	1	/* _Open => open, etc. */
  #endif /* __ORBIS__ */
 #endif /* !defined(_USE_EXISTING_SYSTEM_NAMES) */

 #if defined(__STDC_WANT_SAFER_LIB__) && (__STDC_WANT_SAFER_LIB__ != 0)
  #define __STDC_SAFER_LIB__	200510L
 #endif /* defined(__STDC_WANT_SAFER_LIB__) && (__STDC_WANT_SAFER_LIB__ != 0) */
...
#define _EXTERN_CONST_DECL	extern const
 ...
 #if _HAS_OPENCL
#define _FINVERT(x)	FNAME(Recip)(x)
#define _FDIV(x, y)	FNAME(Divide)(x, y)
...
#define _FDIV(x, y)	((x) / (y))
  ...
  #define _PASTE(a, b)	__CL_INTERNAL__##a##b
...
typedef char *va_list;
 ...
 #if (defined(_WIN32_C_LIB) && (_WIN32_C_LIB != 0)) && !defined(__BORLANDC__)
...
#define _C2			1	/* 0 if not 2's complement */
 ...
 /* defined in limits.h */
 #define _MBMAX		6	/* MB_LEN_MAX. 31-bit UTF-8. */
#elif defined (__psp2__)
 #define _MBMAX		4	/* MB_LEN_MAX. UTF-8 is a standard multibyte stream format on PSP2. */
#else
#define _MBMAX		8	/* MB_LEN_MAX */
#endif /*__ORBIS__, __psp2__*/
...
typedef va_list _Va_list;
 ...
 #if (defined(__EDG__) && (__EDG__ != 0)) && !defined(__x86_64)
  #undef va_copy
 #endif /* (defined(__EDG__) && (__EDG__ != 0)) && !defined(__x86_64) */
...
_END_EXTERN_C
		...
		/* stdio PROPERTIES */
#define __SCE_LIBC_STDIO__ /* B#341 */
#define _FNAMAX	260
#define _FOPMAX	256
#define _TNAMAX	16
...
_STD_END
  ...
  #define _NO_RETURN_NOEXCEPT(fun)  void fun _NOEXCEPT __attribute__((__noreturn__))
  #define _NO_RETURN_PREFIX(fun)  __attribute__((__noreturn__)) void fun
 #else /* 0 < __GNUC__ */
  #define _NO_RETURN(fun)	void fun
  #define _NO_RETURN_NOEXCEPT(fun)	void fun
  #define _NO_RETURN_PREFIX(fun)	void fun
 #endif /* 0 < __GNUC__ */
 ...
 #if 0 < __GNUC__
  #define _NO_RETURN(fun)	void fun __attribute__((__noreturn__))
  #define _NO_RETURN_NOEXCEPT(fun) void fun __attribute__((__noreturn__))
  #define _NO_RETURN_PREFIX(fun) __attribute__((__noreturn__)) void fun
 #else /* 0 < __GNUC__ */
  #define _NO_RETURN(fun)	void fun
  #define _NO_RETURN_NOEXCEPT(fun)	void fun
...
#define _STRINGIZE(x)	_STRINGIZEX(x)
 ...
 #if _HAS_CPP1X
  #define _DEPRECATED_14 [[deprecated]]
 #else /* _HAS_CPP1X */
  #define _DEPRECATED_14
 #endif /* _HAS_CPP1X */

/** SCE Extension for mspace **/
...
#ifndef SCE_SECURE_CPP_OVERLOAD_SECURE_NAMES
#define SCE_SECURE_CPP_OVERLOAD_SECURE_NAMES	1
#endif /* !SCE_SECURE_CPP_OVERLOAD_SECURE_NAMES */
