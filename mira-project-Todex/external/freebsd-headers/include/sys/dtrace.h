...
#if defined(__SCE__) || defined(__ORBIS__)
/*
 * ALL STRUCTS SHOULD BE PACKED TO ENSURE COMPATIBILITY ACROSS HOST AND TARGET...
 * BUT NOT ROLLED SO TIGHT THAT PERF SUFFERS GREATLY...
 */
#pragma pack(push,4)
#endif /* __SCE__ || __ORBIS__ */
...
#if !defined(_KERNEL)
#include <dtrace_plat.h>
#else
#include <sys/types.h>

#if defined(__ORBIS__) || defined(__SCE__)
#include <sys/param.h>
#pragma clang diagnostic ignored "-Wunknown-warning-option" // prevent warning about pragma clang below
#pragma clang diagnostic ignored "-Wunknown-pragmas" // prevent warning about pragma clang below
#pragma clang diagnostic ignored "-Wpragma-pack"  // prevent warning about pragma pack above
...
#endif
#if defined(__ORBIS__) && defined(_KERNEL)
#include <playstation_glue.h>
#endif
...
#if defined(__ORBIS__) || defined(__SCE__)
#define DIF_VAR_THREADNAME		0x0202
#define DIF_VAR_THREADPRIORITY	0x0203
#define DIF_VAR_THREADAFFINITY	0x0204
#define DIF_VAR_PROCNAME		0x0205
#define DIF_VAR_PROCMAINTID		0x0206
#define DIF_VAR_THREADTYPE		0x0207
#endif
...
#if defined(__ORBIS__) || defined(__SCE__)
#define	DIF_SUBR_GETFDTYPE		52
#define	DIF_SUBR_GETFDNAME		53
#define	DIF_SUBR_GETSOCKETTYPE	54
#define	DIF_SUBR_GETSOCKETPORT	55
...
#define	DTRACEOPT_UNSET		(dtrace_optval_t)(uint64_t)-2	/* unset option */
...
#if defined(__ORBIS__)
extern dtrace_id_t dtrace_probe_create_wo_dup(dtrace_provider_id_t, const char *,
    const char *, const char *, int, void *, uint32_t);
#endif
...
extern void dtrace_probe(dtrace_id_t, uintptr_t arg0, uintptr_t arg1,
    uintptr_t arg2, uintptr_t arg3, uintptr_t arg4);
#if defined(__ORBIS__)
extern void dtrace_probe_core(dtrace_id_t id, uintptr_t arg0, uintptr_t arg1,
    uintptr_t arg2, uintptr_t arg3, uintptr_t arg4);
#endif
...
#define	DTRACE_CPUFLAG_ISSET(flag) \
	(cpu_core[sceDtraceCurrentCpu()].cpuc_dtrace_flags & (flag))
