...
// SceShellCore patches - use free prefix instead fake and enable fakepkg
...
#define ssc_ext_hdd_patchA                                 0x00606A0D
#define ssc_ext_hdd_patchB                                 0x00149BF0

// disable screenshot block
#define ssc_disable_screenshot_patch                       0x000DD2A6
